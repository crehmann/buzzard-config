...
lv_obj_t *zmk_display_status_screen() {
    ...
    lv_obj_align(zmk_widget_battery_status_obj(&battery_status_widget), LV_ALIGN_LEFT_MID, 8, 0);
#endif

#if IS_ENABLED(CONFIG_CUSTOM_WIDGET_LAYER_STATUS)
    zmk_widget_layer_status_init(&layer_status_widget, screen);
    lv_obj_align(zmk_widget_layer_status_obj(&layer_status_widget), LV_ALIGN_RIGHT_MID, -8, 0);
#endif
